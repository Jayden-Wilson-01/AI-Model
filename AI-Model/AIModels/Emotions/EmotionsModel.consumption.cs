...
namespace AI_Model.AIModels.Emotions
{
    public partial class EmotionsModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Suggestion");
            if (labelColumn == null)
            {
                throw new Exception("Suggestion column not found. Make sure the name searched for matches the name in the schema.");
            }
